...
//          subject.getSession().setAttribute("user", user);
    ...
    @RequestMapping(value = "forechangeOrderItem",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "foredeleteOrderItem",method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "foredeleteOrder",method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "foreorderRefund",method = RequestMethod.GET)
    public Object orderRefund( int oid) {
        Order o = orderService.get(oid);
        o.setRefund(1);
        orderService.update(o);
        return Result.success();
